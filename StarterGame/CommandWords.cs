...
namespace Ascension
{
    ...
    public class CommandWords
    {
        ...
        private static Command[] _commandArrayInGame = { new GoCommand(), new LookCommand(), new ReflectCommand(), new UnequipCommand(), new LevelCommand(), new BackCommand(), new TakeCommand(), new MenuCommand(), new QuitCommand() };
        ...
        private static Command[] _commandArrayInElevator = { new GoCommand(), new LookCommand(), new ReflectCommand(), new UnequipCommand(), new LevelCommand(), new BackCommand(), new MenuCommand(), new QuitCommand() };
