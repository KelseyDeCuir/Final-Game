...
namespace Ascension
{
    ...
    public class CommandWords
    {
        ...
        private static Command[] _commandArrayInElevator = { new GoCommand(), new LookCommand(), new ReflectCommand(), new EquipCommand(), new UnequipCommand(), new LevelCommand(), new EnchantCommand(), new BackCommand(), new MenuCommand(), new QuitCommand() };
